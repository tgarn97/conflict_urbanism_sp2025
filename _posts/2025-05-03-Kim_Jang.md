...
.scroll-stage {
  ...
  overflow: hidden;
  margin: 0 auto;
  transform: translateX(-40%); /* 중앙 정렬 보정 */
}
...
<div class="scroll-stage">
  <div class="scroll-frame">
    <!-- 기본 map01은 항상 표시 -->
    <img class="map-slide active" src="{{ site.baseurl }}/images/Kim_Jang/map01.png" id="map-default" />
    <!-- 이후 map 시퀀스 -->
  ...
  <div class="timeline-box" id="timelineBox">
    ...
    <div class="timeline-step" data-map="12">
      <p><strong>23:48</strong> Additional Surveillance</p>
      <img src="{{ site.baseurl }}/images/Kim_Jang/image09.jpg" />
    </div>
    <div class="timeline-step" data-map="13">
      <p><strong>00:05</strong> Martial law forces storm National Assembly</p>
    ...
    <div class="timeline-step" data-map="15">
      <p><strong>01:00</strong> Martial law lifted, Resolution passed unanimously</p>
