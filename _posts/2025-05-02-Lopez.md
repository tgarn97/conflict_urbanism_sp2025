...
<div style="display: flex; gap: 20px; flex-wrap: wrap;">
  ...
  <div style="flex: 1; min-width: 300px;">
    <h3>Column 1: Text</h3>
    <p>This is the first column. You can add any Markdown content here, like <strong>formatted text</strong>, lists, or links.</p>
    <ul>
      <li>Item A</li>
      <li>Item B</li>
    </ul>
  ...
  <div style="flex: 1; min-width: 300px;">
    <h3>Column 2: Image</h3>
    <img src="https://via.placeholder.com/300x200" alt="Placeholder image" style="width:100%; border:1px solid #ccc;">
    <p style="font-size: 0.9em; color: #555;"><em>Figure 1: Example image with caption</em></p>
  </div>
...
![Pollution in Biscane Bay](/conflict_urbanism_sp2025/images/Baker_Lin_Lopez/Electricity Network.png)
*Figure 1: Turkey Point electrical network.*
